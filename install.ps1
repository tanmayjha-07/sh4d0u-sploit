# sh4d0u-sploit — dependency installer for Windows (Chocolatey + official Metasploit MSI).
...
if ($Components -ne "") {
    ...
    Write-Host ""
    Write-Host "sh4d0u-sploit — Windows dependency installer" -ForegroundColor Green
